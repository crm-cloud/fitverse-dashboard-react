-- Fix create_admin_account_atomic to work with current schema
-- Remove organization_usage insert since table doesn't exist yet
...
BEGIN
  ...
  -- Create organization (using gyms table as organizations for now)
  ...
  -- Initialize gym_usage for the organization
