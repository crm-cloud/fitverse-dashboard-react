...
import MemberProfile from "./pages/members/[id]/profile";

// Trainer Pages
import TrainerManagement from "./pages/trainers/management";
...
// Diet & Workout Pages
import DietWorkoutPlanner from "./pages/diet-workout/planner";

// Feedback Pages
import FeedbackManagement from "./pages/feedback/management";

// Task Pages
import TaskManagement from "./pages/tasks/management";
